  ...
  return (
    <div className="bg-white px-4 md:px-10 lg:px-16 py-16">
      ...
      <StaggeredContainer className="grid grid-cols-1 mx-auto md:grid-cols-2 gap-8 max-w-md md:max-w-4xl w-full">
        <div className="bg-[#FCFCFC] md:text-[18px] text-center md:leading-[28px] text-[10px] leading-[16px] overflow-hidden aspect-[570/398] flex flex-col border border-black/5 rounded-[8px] p-6 pb-0">
          <h2 className="font-semibold  mt-4 mb-2">Projects</h2>
        ...
        <div className="bg-[#FCFCFC] md:text-[18px] text-center md:leading-[28px] text-[10px] leading-[16px] overflow-hidden aspect-[570/398] flex flex-col border border-black/5 rounded-[8px] p-6 pb-0">
          <h2 className="font-semibold mt-4 mb-2">Member profiles</h2>
